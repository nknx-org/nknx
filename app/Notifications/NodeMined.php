...
class NodeMined extends Notification
{
    ...
    {
        if(isset($notifiable->notificationPreferences['node_mined_block'])){
            return $notifiable->notificationPreferences['node_mined_block'];
        } else{
            return [];
        }
    }
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
            ...
            ->subject('Your Node got a mining reward')
            ->line("Ka-ching! Your node with the IP " . $this->node->addr . " earned a dime.")
            ->action('View my nodes', url('/nodes'))
            ->line('Getting rewarded is a very good sign that the whole NKN network benefits from your node. Keep your node running with a good and reliable connection and you will soon be driving that Lambo you always dreamt about!');
    }
    ...
    {
        return [
            'header' => "Node earned a mining reward!",
            'excerpt' => "Ka-ching! Your node with the IP " . $this->node->addr . " earned a dime.",
            'text' => "
                ...
                <p>Your node with the IP <b>" . $this->node->addr ."</b> mined a block!</p>
                <p>Getting rewarded is a very good sign that the whole NKN network benefits from your node. Keep your node running with a good and reliable connection and you will soon be driving that Lambo you always dreamt about!</p>
